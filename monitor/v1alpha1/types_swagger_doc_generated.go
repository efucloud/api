...
var map_ClusterDashboard = map[string]string{
	"": "ClusterDashboard  cluster information",
}

func (ClusterDashboard) SwaggerDoc() map[string]string {
	return map_ClusterDashboard
}

var map_ClusterDashboardList = map[string]string{
	"": "ClusterDashboardList contains a list of ClusterDashboard",
}

func (ClusterDashboardList) SwaggerDoc() map[string]string {
	return map_ClusterDashboardList
}
...
func (ClusterDashboardSpec) SwaggerDoc() map[string]string {
	return map_ClusterDashboardSpec
}

var map_ClusterDashboardStatus = map[string]string{
	"lastReportTime":  "agent last report time",
	"nodes":           "cluster's nodes information, agent will report this information key is node role",
	"namespaceNumber": "cluster's namespace number, agent will report this information",
}

func (ClusterDashboardStatus) SwaggerDoc() map[string]string {
	return map_ClusterDashboardStatus
}
...
func (WorkspaceDashboard) SwaggerDoc() map[string]string {
	return map_WorkspaceDashboard
}

var map_WorkspaceDashboardList = map[string]string{
	"": "WorkspaceDashboardList contains a list of WorkspaceDashboard",
}

func (WorkspaceDashboardList) SwaggerDoc() map[string]string {
	return map_WorkspaceDashboardList
}
...
func (WorkspaceDashboardSpec) SwaggerDoc() map[string]string {
	return map_WorkspaceDashboardSpec
}
...
func (WorkspaceDashboardStatus) SwaggerDoc() map[string]string {
	return map_WorkspaceDashboardStatus
}
